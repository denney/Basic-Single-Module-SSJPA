...
public class HttpUtil {
    ...
    private static String invokeUrl(String url, Map params, Map<String, String> headers, int connectTimeout, int readTimeout, String encoding, HttpMethod method) {
        ...
        try {
            ...
            String App_Secret = Constant.App_Secret;
            ...
            conn.setRequestProperty("App-Key", Constant.App_Key);
            conn.setRequestProperty("Nonce", Nonce);
            conn.setRequestProperty("Timestamp", Timestamp);
            conn.setRequestProperty("Signature", TestMd5AndSha1.sha1(App_Secret + Nonce + Timestamp));
